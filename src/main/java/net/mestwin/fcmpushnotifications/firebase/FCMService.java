...
public class FCMService {
    ...
    private Message getPreconfiguredMessageWithoutData(PushNotificationRequest request) {
        return getPreconfiguredMessageBuilder(request).setTopic(request.getTopic()).setToken("cUSl4hkSQ1-nEi-kFmBeLl:APA91bHlH-jO_jOFhk1kvEvxbJLnsrvWcJXBdUw6MvY7ztwwE4_4tm9qZ5lu7FzBZ5Rhuu02lliwmZESm2SqBQbZdE3M9u91ULQqR6Y4RoPQzx7_OsEDt6R43TGZsndyKSTUEFubjZkE")
                .build();
    }
